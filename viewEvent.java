...
public class viewEvent extends AppCompatActivity implements AdapterView.OnItemClickListener {
   ...
   /* ArrayList<String> listItems = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = new Intent(viewEvent.this,HomeOrg.class);
        maill1 = findViewById(R.id.maill8);
        Intent intent;
        intent = getIntent();
      ...
      //  initializeListView();
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("events").child(fml);
        ...
        reference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                coursesArrayList.add(snapshot.child("ecode").getValue(String.class));
